...
### Data & APIs
- [07 — Databases & ORM](07-databases-and-orm.md) — RDBMS vs NoSQL, joins, indexing, EF Core, entity modelling, aggregates, CDC. *(Summary level — the depth is in the [SQL track](../SQL/readme.md).)*
